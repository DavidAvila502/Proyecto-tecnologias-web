    ...
    <section className="social_container">
      ...
      <ul className="social_list mr_42">
        <li className="social_list-item mr_13">
          <img src="assets/images/facebook.svg " className="social_image" />
        </li>
        <li className="social_list-item mr_13">
          <img src="assets/images/github.svg" className="social_image" />
        </li>
        <li className="social_list-item">
          <img src="assets/images/instagram.svg" className="social_image" />
        </li>
      </ul>
    </section>
  );
